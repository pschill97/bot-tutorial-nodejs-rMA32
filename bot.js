var HTTPS = require('https');
	...
	postMessage("http://daddyleagues.com/NL/team/"+request.text.substring(5,8)+"/depthchart");
	this.res.end();
	}
	...
	postMessage("http://daddyleagues.com/NL/team/"+request.text.substring(5,8)+"/schedule");
	this.res.end();
	}
	...
	var rep = req.replace(/ /,"+");
	postMessage("http://daddyleagues.com/NL/players?name="+rep+"&position=all&team=all");
